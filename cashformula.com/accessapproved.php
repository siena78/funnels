...
<head>
  ...
  <link rel="stylesheet" href="css/popup.css%3Fv=1.css" media="screen" /><style>
    ...
    .sub-btn2arr-n::before{
        background: none;
    }
    #vid-opt-area{padding-top: 15px}
...
<div id="fe2">
    <div id="top-logo">
        <div class=""><!-- big-container -->
            <div class="row">
                <div class="col-sm-12">
                <div style="text-align:center;"><img src="images/header-logo-tm3.png" alt="" /> <!--<span class="register-logo">&trade;</span>--> </div>
              </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="js/bootstrap.js"></script>    <div id="overlay" class="modal exit-page fade" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="chance_wrap">
                    ...
                    <div class="modal_form">
                        <div class="form_inner_wrap2" id="remove_befor_arrow">
                            <form id="submit_form" class="submit_form" accept-charset="utf-8" method="post" action="javascript:;">
                                <div class="col-sm-12">
                                    <button class="click_proceed btn sub-btn2-n" onclick="gotoMem();"></button>
                                                                    </div>
                            </form>
                            <div class="clearfix"></div>
                        </div>
        ...
        jQuery(document).ready(function(){
            ...
            jQuery(document).mousemove(function(e) {
                if(e.pageY <= 15 && is_ovrly_closed == 0)
                {
                    ...
                    {
                        wistiaEmbed.pause();
                        $('#overlay').find('#overVid').html(ovrVidhtml);

                    }
                    is_shown = 1;
                }
                $('body').on('hidden.bs.modal', '#overlay', function() {
                    $('#overlay').find('#overVid').html('<img src="images/video_img.jpg" alt="" />');
    ...
    setInterval(function(){
        if(testi_counter == 1){
            $("#testi_row2, #testi_row3, #testi_row4").fadeOut(500);
            $("#testi_row1").delay(500).fadeIn(700);
        }else if(testi_counter == 2){
            $("#testi_row1, #testi_row3, #testi_row4").fadeOut(500);
            $("#testi_row2").delay(500).fadeIn(700);
        }else if(testi_counter == 3){
            $("#testi_row2, #testi_row1, #testi_row4").fadeOut(500);
            $("#testi_row3").delay(500).fadeIn(700);
        }else if(testi_counter == 4){
            $("#testi_row2, #testi_row3, #testi_row1").fadeOut(500);
            $("#testi_row4").delay(500).fadeIn(700);
        }
        if(testi_counter >= 4){
            testi_counter = 1;
        }else {

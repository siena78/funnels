...
<head>
  ...
  <link rel="stylesheet" href="css/popup.css%3Fv=1.css" media="screen" /><link rel="stylesheet" href="css/overlay_css.css" media="screen" />
<style>
  #vid-screen{max-width:950px;}
  .enter-email-txt{text-align: center; font-size: 20px;}
  
  #myModal .modal-content, #overlay .modal-content {background: url(images/chance_header.jpg) no-repeat #fff !important; border:0px;}
    #remove_befor_arrow::before{
        background: none;
    }
    .chance_headr #overVid {
        margin: 0 auto;
        max-width: 490px;
    }
    ...
    button, html input[type="button"], input[type="reset"], input[type="submit"]{
      background: rgba(0, 0, 0, 0) url("images/open_cash_btn.png") no-repeat scroll 0 0 / 100% auto;
    }
</style>
</head>
<body>
  <div id="fe1-bg">
    <div id="vid-opt-area"> <!-- vid-opt-area -->
      <div class="container">
        <div class="row">
            ...
            <div class="form-box1">
              <form id="submit_form" class="submit_form" accept-charset="utf-8" method="post" action="javascript:;">
                <div class="row">
                  <div class="col-md-6">
                    <label>
                      <input type="text" class="name-icon" id="fname" name="name" value="" placeholder="Geben Sie hier Ihren vollständigen Namen ein" />
                    </label>
                  </div>
                  <div class="col-md-6">
                    <label>
                      <input type="email" class="email-icon" id="email" name="email" value placeholder="Geben Sie hier Ihre E-Mail-Adresse ein"/>
                    </label>
                  </div>
              ...
              <p align="center" class="gurantee-txt"><img src="images/lock-icon.png" alt=""  align="absmiddle" /> GARANTIERT SICHERER ZUGRIFF WIRD DURCH VERTRAUENSWÜRDIGE UNTERNEHMEN GEWÄHRLEISTET</p>
...
<div id="footer">
    ...
    <img alt="" src="images/bell_icon.png">
    <p id="name_email_change">
        <span id="name_change">John</span> hat gerade CashFormula-DE verbunden!
        <label>
          <span id="email_change">john***@gmail.com </span>    <span id="people_last_time">1 min vor</span>
        </label>
        <a href="index.php#" class="emailw_cross"><img alt="" src="images/cross_org.png"></a>
    </p>
</div>
<script>
    ...
    function widget_earning_html() {
        if (widget_close_decision == 0) {
            $("#name_email_people_filling").fadeIn('slow').delay(2000).fadeOut('fast');
            ...
            var ran_mints = "";
            if (s == 1)
                ran_mints = "1 minute vor";
            else
                ran_mints = s+" minuten vor";

            randname = randname.toLowerCase().replace(/\b[a-z]/g, function(letter) {
                return letter.toUpperCase();
            });
            $("#name_change").html(randname.substr(0, 6));
            $("#email_change").html(randemail);
            $("#people_last_time").html(ran_mints);
        }
    }
    ...
    $(document).ready(function(){
        $(".emailw_cross").click(function(e){
            e.preventDefault();
            $("#name_email_people_filling").hide();
            widget_close_decision = 1;
        });
    });
</script>
<script>
...
<div class="loader-area">
    ...
    <p align="center" class="almost">... FAST FERTIG!</p>
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content" style="background-color:transparent !important ; box-shadow:0 0 75px 0 #fe8524;">
          ...
          <div class="chance_wrap">
            <div class="chance_headr">
              <h2 style="font-family: 'Oswald', sans-serif;color: #fff;text-align:center; padding: 10px 45px; margin-bottom: 0px; font-size: 25px;">GEHEN SIE NICHT MIT LEEREN HÄNDEN!</h2>
              <p style="font-family: 'Oswald', sans-serif;color: #fff; margin:10px auto 20px;">LADEN SIE "CASH FORMULA’S MULTI-BILLION DOLLAR SECRET LOOPHOLE REVEALED" HERUNTER (WERT $99 - HEUTE KOSTENLOS)</p>
            </div>
            <div class="book_wrap_pop">
              <div class="col-md-4">
                <div class="pop_book">
                  <img src="images/3debook_3d-copy.png" alt="" width="100%" />
                </div>
              </div>
              <div class="col-md-8">
                <div class="pop_book_text">
                  <ul>
    ...
    <script type="text/javascript">
      ...
      jQuery(document).ready(function(){
        ...
        jQuery('#submit_ovelay').click(function(event) {
          jQuery("#overlay_form").submit();
        });

        jQuery('#overlay_form').submit(function(event) {
          event.preventDefault();
          var semail = jQuery(this).find("input[name='email']").val();
          validateEmail(semail, 'overlay', 'cfoverlayfriend');
        });
      }); 
    </script>
      <!-- Start of ExitSplash.com Code -->
  <script type="text/javascript">
    var mem_rdirect = "accessapproved.php";
    var from_page = 'fe';
  </script>
</body>
</html>

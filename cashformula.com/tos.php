...
<body>
  ...
  <tr>
    <td height="70" align="center" style="color:#111; font-size:24px"><strong>CashFormula WEBSITE TERMS OF USE <br />
      <br />
  ...
  <tr>
    <td align="left">Thank you for visiting the website (the &ldquo;Website&rdquo;)   			on which you found the link to these Terms Of Use (the &ldquo;Website&rdquo;).   			 The Website is an Internet property of CashFormula.   			(referred to collectively as &ldquo;CashFormula,&rdquo; &ldquo;we&rdquo; and &ldquo;us&rdquo;).  You   			agree to be bound by these CashFormula Website Terms of Use (&ldquo;Terms   			of Use&rdquo;), in their entirety, when you: (a) access the Website; (b)   			register for a newsletter or subscribe to a mailing list or request   			information by and through the Website (&ldquo;Subscription Services&rdquo;);   			(c) register to participate in promotions, contests and/or   			sweepstakes offered by CashFormula from time to time (each, a   			&ldquo;Contest&rdquo;); (d) join, or attempt to join, an affiliate program or   			other membership organization featured on the Website (&ldquo;Membership   			Services&rdquo;); and/or (e) order a product and/or service through the   			Website (&ldquo;Vendor Services, and together with the Subscription   			Services and Membership Services, the &ldquo;Services&rdquo;).  CashFormula   			Privacy Policy (&ldquo;Privacy Policy&rdquo;), the Official Contest Rules   			applicable to each Contest, CashFormula Purchase Agreement(s)   			(&ldquo;Purchase Agreement&rdquo;), CashFormula Membership Agreement(s)   			(&ldquo;Membership Agreement&rdquo;), as well as any other operating rules,   			policies, price schedules and other supplemental terms and   			conditions or documents that may be published from time to time, are   			expressly incorporated herein by reference (collectively, the   			&ldquo;Agreement&rdquo;).  Please review the complete terms of the Agreement   			carefully.  If you do not agree to the Agreement in its entirety,   			you are not authorized to use the Services and/or Website in any   			manner or form. <br />
      ...
      <br />
      <a href="mailto:support@cashformulamembersarea.com" target="_blank">support@cashformulamembersarea.com</a> <br />
      CashFormula<br />

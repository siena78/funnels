...
<div class="container-fluid text-center" id="top">
    <div class="row" style="background-image: url('http://de-centument.com/deaa/members/images/header-bg.png');">
        <div class="container">
            ...
            <div class="col-md-8 col-xs-12">
				<iframe id="vid" src="https://player.vimeo.com/video/171339510?autoplay=1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			</div>
            <div class="col-md-4 col-xs-12 no-padding" id="form-container">
                <div id="form-header" class="arrow_box">
					...
					<div class="wl-signup" style="width: 90%;margin:auto"></div>
					<img width="90%" style="display:inline-block;margin:auto;margin-top:20px" src="http://de-centument.com/deaa/images/badges.png"/>
                </div>
            </div>
        </div>
    </div>
...
<script src="https://whitelabelrobot.com/robots/binary/192/integration/signup.js?default_broker=1&default_language=auto" defer></script>
</body>
</html>
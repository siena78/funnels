...
<body>
  <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
    <td align="left">
      Diese Datenschutzrichtlinie regelt die Art und Weise, in der fastcash-de.biz Informationen von Nutzern (jeweils ein „Nutzer”) der fastcash-de.biz.com Website („Website”) sammelt, verwendet, pflegt und offenbart.Diese Datenschutzerklärung gilt für die Website sowie für alle von fastcash-de.biz angebotenen Produkte und Dienstleistungen.
      <br /><br />
      ...
      fastcash-de.biz sammelt und verwendet personenbezogene Daten der Nutzer zu folgenden Zwecken:
      <br /><br />
      Zur Verbesserung des Kundenservice Ihre Daten helfen uns, auf Ihre Kundendienstanfragen und Supportanfragen effizienter reagieren zu können.<br />Zur Personalisierung der Anwendererfahrung Wir können Informationen insgesamt verwenden, um zu verstehen, wie unsere Nutzer als Gruppe die Dienste und Ressourcen nutzen, die wir auf unserer Website zur Verfügung stellen.<br />Zur Bearbeitung von Zahlungen Wir verwenden die Daten, die uns die Nutzer über sich zur Verfügung stellen, wenn sie einen Auftrag erteilen, nur für den Service für diesen Auftrag. Wir geben diese Informationen nicht an Dritte weiter, außer in dem Umfang, der notwendig ist, um die Dienstleistung zu erbringen.<br />Zur Durchführung von Promotions, Wettbewerben, Umfragen oder anderer Funktionen der Website Um Nutzern Informationen zu senden, deren Empfang sie zugestimmt haben, über Themen, von denen wir meinen, dass sie von Interesse für sie sind.<br />Zum regelmäßigen Versand von E-Mails Wir verwenden die E-Mail-Adressen für den Versand von Benutzerinformationen und Updates, die deren Auftrag betreffen. Sie können auch dafür verwendet werden, um auf Anfragen, Fragen und/oder Anfragen der Nutzer zu reagieren.
      <br /><br />
      <strong>Wie wir Ihre Daten schützen</strong><br />
      Wir verwenden geeignete Methoden zur Datensammlung, Speicherung und Verarbeitung sowie Sicherheitsmaßnahmen zum Schutz vor unbefugtem Zugriff, Veränderung, Weitergabe oder Vernichtung Ihrer persönlichen Daten, Benutzernamen, Passwort, Transaktionsdaten und Daten, die auf unserer Website gespeichert sind.
      <br /><br />
